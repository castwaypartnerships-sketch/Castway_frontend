...
function PortfolioItems({
  ...
  items: { id: string; title: string; imageUrl: string; description?: string | null; link?: string | null }[];
}) {
  ...
  async function handleAdd(event: FormEvent<HTMLFormElement>) {
    event.preventDefault();
    await addItem({ title, imageUrl, description: description || undefined }).unwrap();
    setTitle("");
    setImageUrl("");
    setDescription("");
    setShowForm(false);
